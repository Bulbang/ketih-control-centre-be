...
export async function up(db: Kysely<any>): Promise<void> {
    await db.schema
        ...
        .addColumn('periperal_description', 'text', (col) => col)
        ...
        .addColumn('request_fulfilled_date', 'timestamp', (col) => col)
        .addColumn('serial_number', 'varchar(100)', (col) => col)
        .addColumn('country', 'varchar(100)', (col) => col)
        .addColumn('expected_arrival_date', 'date', (col) => col)
        ...
        .addColumn('return_shipping_status', 'varchar(100)', (col) => col)
        .addColumn('return_tracking_number', 'varchar(100)', (col) => col)
        .addColumn('return_delivery_date', 'timestamp', (col) => col)
