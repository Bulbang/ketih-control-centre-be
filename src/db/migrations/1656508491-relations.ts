...
export async function up(db: Kysely<any>): Promise<void> {
    await Promise.all([
     db.schema
        ...
        .addForeignKeyConstraint('event_xp_id_fk', ['xp_event_id'], 'event', [
            'event_id',
        ])
        .execute(),
     db.schema
     ...
     db.schema
        ...
        .addForeignKeyConstraint('item_FK', ['item_id'], 'item', ['item_id'])
        .execute(),
    ])
}
...
export async function down(db: Kysely<any>): Promise<void> {
    await Promise.all([
        ...
        db.schema
            ...
            .execute(),
        db.schema.alterTable('incident').dropConstraint('event_id_FK').execute(),
